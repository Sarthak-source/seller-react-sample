      ...
      <tbody>
        {jsonData.map((item, index) => (
          <tr key={index}>
            ...
            <td style={{ border: '1px solid black', padding: '8px',borderSpacing: 0 }}>{/* Add product data here */}</td>
            <td style={{ border: '1px solid black', padding: '8px',borderSpacing: 0 }}>{/* Add seal number here */}</td>
          </tr>
        ))}
      </tbody>
    </table>
